...
// Define a class named Master that extends DBConnection
Class Master extends DBConnection {
	...
	public function __destruct(){
	  ...
	  // Function to capture errors and return JSON response
	...
	// Function to save or update category information
	...
	function delete_category(){
	 ...
	 // Function to save or update brand information
	function save_brand(){
		extract($_POST);
		$data = "";
		foreach($_POST as $k =>$v){
	...
	function delete_brand(){
	 ...
	 // Function to save or update car information
	function save_car(){
	...
	// Function to save or update inquiry information
...
// Create an instance of SystemSettings class
$sysset = new SystemSettings();
// Switch statement to determine the action and call the appropriate function
switch ($action) {
	case 'save_category':
