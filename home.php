        ...
        <div class="container-fluid">
            ...
            <a href="./?page=view_product&id=<?= $row['id'] ?>" class="card text-decoration-none text-dark car-item m-2">
                <div class="banner-img-holder">
                    <img src="<?= validate_image("uploads/banners/car-{$row['id']}.png?v={$row['date_updated']}") ?>" alt="" class="img-top banner-img bg-info">
                </div>
                <div class="card-body">
                    <div class="col-12">
                        ...
                        <hr class="border-primary mb-0">
                            <div>
                                ...
                                <span class="text-muted text-bold">₱ <?= number_format($row['price'],2) ?></span>
                            </div>
                        <p class='truncate-3'>
